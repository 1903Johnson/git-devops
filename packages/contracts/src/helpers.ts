...
export type MfaEnrollmentRequired = components['schemas']['MfaEnrollmentRequired'];
export type MfaEnrollmentStart = components['schemas']['MfaEnrollmentStart'];
export type MfaEnrollmentRequest = components['schemas']['MfaEnrollmentRequest'];
export type MfaEnrollmentConfirmRequest = components['schemas']['MfaEnrollmentConfirmRequest'];
export type MfaEnrollmentConfirmed = components['schemas']['MfaEnrollmentConfirmed'];
